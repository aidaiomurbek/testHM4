...
public class Main {
    ...
    public  static void medicHeal(){ //у всех методов есть скобки и тело
        Random random = new Random();
        int heroIndex = random.nextInt(heroesDamage.length);  //shift.fn.f6 переименование
        if ( heroesHealth[3] > 0 && heroesHealth[heroIndex] < 100 && heroesHealth[heroIndex] > 0){
            heroesHealth[heroIndex]=heroesHealth[heroIndex] + heal;
